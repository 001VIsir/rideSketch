...
- **前端**:
  - 状态: ✅ 已通过
  - 文件: `api/community.ts`, `views/community/CommunityPage.vue`
- **优先级**: 高
...
- **前端**:
  - 状态: ✅ 已通过
  - 文件: `views/community/CommunityPage.vue`
  - 路由: `/community`
- **优先级**: 高
...
- **前端**:
  - 状态: ✅ 已通过
  - 文件: `views/community/RouteDetailPage.vue`
  - 路由: `/community/route/:id`
- **优先级**: 高
